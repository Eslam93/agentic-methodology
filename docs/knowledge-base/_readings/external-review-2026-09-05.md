...
| R5 | a Tier 3 task can end with no independent review if the owner declines every menu item | held at `bac12dc`; closed 2026-09-05 by D-19 | `standing-orders.md` review menu; `work/SKILL.md:109` "run what they pick"; D-06 "the owner wanted to choose per task". Tier 3 now finishes on a completed independent review or an explicit waiver, both recorded in the brief and checked at hand-back |
